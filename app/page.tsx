    ...
    <div className="split-container">
      ...
      <div className="left-panel">
        <div className="left-content">
          ...
          <p>
            <a href="https://www.getautopsy.io/" target="_blank" rel="noopener noreferrer"><strong>Autopsy</strong></a>, largest dataset on failed startups globally, analyzing failed company data for VCs, research and academia with a 10k+ community subscriber base.
          </p>
          ...
          <h2>Selected talks and programs</h2>
          <ul className="talks-list">
            ...
            <li><a href="https://x.com/mmazco/status/2021653210440904984?s=20" target="_blank" rel="noopener noreferrer">Cartesia x Anthropic Voice Agents Hackathon hosted by Notion</a> SF Feb 2026</li>
          </ul>
